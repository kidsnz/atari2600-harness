...
func GenerateSymmetricASM(art []string, water, lily []byte, opts SceneOpts) (string, error) {
	...
	fmt.Fprintf(&b, `; monet_m1 — generated by roms/frogger/gen (internal/playfield.GenerateSymmetricASM)
...
func GenerateFroggerASM(bg, grp0 []byte, frogGfx []byte, nusiz0, colup0, colup1, hmp0 byte) (string, error) {
	...
	var b strings.Builder
	fmt.Fprintf(&b, `; Monet Frogger (playable) — internal/playfield.GenerateFroggerASM
        processor 6502
VSYNC   = $00
VBLANK  = $01
WSYNC   = $02
