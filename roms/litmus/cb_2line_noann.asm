; cb_2line_noann — planted twin of cb_2line WITHOUT the @lines note: the same 2-line region is over the 1-line budget and must be flagged. VV-2 green-ification litmus: a legitimate 2-LINE kernel. Each visible
