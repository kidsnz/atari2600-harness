...
func TestRefusalClassesAccountForEveryUnboundedAddress(t *testing.T) {
	...
	t.Logf("FORCED so far: WSYNC-in-body said +5.7 and is worth +0.0; multiple back-edges said +6.7 and")
	t.Logf("is worth +0.0; unresolved bank switch said +23.1 and is worth +15.3 (and 60%% of that is one")
	t.Logf("cartridge, Vanguard). Two of three predictions were zero. See docs/capability-gap-audit.md.")
