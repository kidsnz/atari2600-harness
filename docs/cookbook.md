...
| **platformer** | `two_line_kernel`, `multicolor48`, `pf_modes` (reflect), `bullets`, subpixel physics | fixed-point 8.8 movement (gravity/friction = carry-driven); reflected-PF lets player drop both edges | RESxx draw delay; player-width 1-clk shift | `design.BackgroundSpec` |
