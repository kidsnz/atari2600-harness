...
| HMOVE strobe-cycle axis (HM=0): cycles 21..54 are a dead band (no motion at any nibble); the column reaches −5 at cycles 69–70; cycles 73 and 74 are identical, so the "no comb" window is **two** cycles wide | `litmus_hmove_mid`, `TestHmoveMidCyclesAgreeWith1998Table` | measured strobes land at CPU cycles 27, 51, 70 and match Bradford Mott's 1998 full-line sweep (`199804/msg00198`) exactly; two negative controls fire |
